...
class UploadFilesControllerTest < ActionController::TestCase
  ...
  test "should create upload_file" do
    assert_difference('UploadFile.count') do
      post :create, upload_file: { path: @upload_file.path, size: @upload_file.size, title: @upload_file.title, type: @upload_file.type }
    end
  ...
  test "should update upload_file" do
    patch :update, id: @upload_file, upload_file: { path: @upload_file.path, size: @upload_file.size, title: @upload_file.title, type: @upload_file.type }
    assert_redirected_to upload_file_path(assigns(:upload_file))
  end
